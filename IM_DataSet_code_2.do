use "C:\Users\16056\OneDrive\Desktop\Resource Economics-Research\Stata  Resource Economics\Imputed_data_set_2.dta

use "C:\Users\16056\OneDrive\Desktop\Resource Economics-Research\Stata  Resource Economics\FactorAnalysis.dta"  

************************************ index variable creation**********************************************
**********************************************************************************************************
mi set wide

mi register imputed commatt_11 commatt_21 commatt_31 commatt_41 commatt_71 commnetwork51 commnetwork61 commnetwork71 commnetwork81 commnetwork91 coordinatedfs1 comminvestdfs1 taxbreaks1 lowinsurance1  lawmaintain1 govtsubsidy1 protectvoluntary1 similarvalue1 similargoal1 similarthink1 samepriorities1 nearneighbor1 otherneighbor1 respcommmunity1  hhfirerroof hhfirersiding hheaves hhsparkchimneys hhventsmmesh hhskirtingdecks
...
#delimit;
gen byte communityatt1=round(((_5_commatt_11+
                               _5_commatt_21+
							   _5_commatt_31+
							   _5_commatt_41+
							   _5_commatt_71)/5)*100);
...
#delimit;
gen byte wildfireplanning1=round(((_5_commnetwork51+
                                   _5_commnetwork61+
								   _5_commnetwork71+ 
								   _5_commnetwork81+ 
								   _5_commnetwork91+  
								  _5_coordinatedfs1+ 
								   _5_comminvestdfs1)/7)*100);
#delimit cr
...
#delimit;
gen byte govtpolicyFSI1=round(((_5_taxbreaks1+ 
                                _5_lowinsurance1+ 
								_5_lawmaintain1+ 
								_5_govtsubsidy1+
								_5_protectvoluntary1)/5)*100);
#delimit cr
...
#delimit;
gen byte landmanage1=round(((_5_similarvalue1+
                              _5_similargoal1+ 
							  _5_similarthink1+ 
							  _5_samepriorities1)/4)*100);
#delimit cr
...
#delimit;
gen byte externaleffect1=round(((_5_nearneighbor1+ 
                                 _5_otherneighbor1+
								 _5_respcommmunity1 )/3)*100);
#delimit cr
...
tab1  _5_hhfirerroof+ _5_hhfirersiding+ _5_hheaves+ _5_hhsparkchimneys+ _5_hhventsmmesh+ _5_hhskirtingdecks
...
#delimit;
gen byte householdfsp1=round(((_5_hhfirerroof+ 
                              _5_hhfirersiding+ 
							  _5_hheaves+ 
							  _5_hhsparkchimneys+ 
							  _5_hhventsmmesh+
							  _5_hhskirtingdecks )/6)*100);
#delimit cr
